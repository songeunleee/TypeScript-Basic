{
  ...
  //
  const sweetCnadyMachine = new SweetCoffeeMaker(12, candySugar);
  const sweetMachine = new SweetCoffeeMaker(12, sugar);

  const latteMachine = new CaffeLatteMachine(22, "ss", cheapMilkMaker);
  const coldLatteMachine = new CaffeLatteMachine(22, "ss", coldMilkMaker);
